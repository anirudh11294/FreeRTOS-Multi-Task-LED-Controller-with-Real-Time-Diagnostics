...
typedef enum _Mode_t { MODE_NONE, MODE_EMERG, MODE_TASK1, MODE_TASK2, MODE_TASK3 } Mode_t;

extern TaskHandle_t task_var;
extern TaskHandle_t emergency_task;
extern TaskHandle_t cmd_task;
extern TaskHandle_t print_task;
extern TaskHandle_t rtc_task;
extern TaskHandle_t led_task;
extern QueueHandle_t q_data;
extern Mode_t curr_state;
extern SemaphoreHandle_t binary_sem;
extern SemaphoreHandle_t mutex;
extern SemaphoreHandle_t active_lock;
extern volatile uint32_t shared_counter;
extern volatile uint8_t use_mutex;
extern volatile uint8_t inversion_active;

extern TimerHandle_t  handle_led_timer[4];
extern TimerHandle_t rtc_timer;
extern UART_HandleTypeDef huart2;
extern RTC_HandleTypeDef hrtc;
extern delay_period xTimeInMs;
...
#define TASK2_LED	LD4_Pin
#define TASK1_LED	LD3_Pin
#define TASK3_LED	LD6_Pin
#define EMERGENCY_LED   LD5_Pin
